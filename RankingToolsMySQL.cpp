	...
	if (regex_search(START, regex("START1"))) {
		...
		for (string& current_schema : schemas) {
			...
			<table class='tabela_etapa' id=')" + current_schema + current_table + R"('>
				...
				<th class='TG-Long' id='Nome'>lastName</th>
				<th class='TG-Long' id='Equipe'>teamName</th>
                <th class='TG-Mid' id='Punicao_Tempo'>Punicao_Tempo</th>
                <th class='TG-Mid' id='Punicao_Pontos'>Punicao_Pontos</th>
                <th class='TG-Mid' id='Punicoes_Adicionais'>Punicoes_Adicionais</th>
				...
				<tr>
					...
					<td>)" + to_string(result->getInt(21)) + R"(</td>
					<td>)" + to_string(result->getInt(22)) + R"(</td>
					<td>)" + to_string(result->getInt(23)) + R"(</td>
					<td>)" + to_string(result->getInt(24)) + R"(</td>
				</tr>
							)";
						}
