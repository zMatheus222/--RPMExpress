...
namespace TXT_Style {
	...
	const std::string ENDS = "\033[0m\n";

	namespace BG {

		const std::string PRETO = "\033[40m";
		const std::string VERMELHO = "\033[41m";
		const std::string VERDE = "\033[42m";
		const std::string AMARELO = "\033[43m";
		const std::string AZUL = "\033[44m";
		const std::string MAGENTA = "\033[45m";
		const std::string CIANO = "\033[46m";
		const std::string BRANCO = "\033[47m";
	}

	const std::string PADRAO = "\033[0m";
	const std::string NEGRITO = "\033[1m";
	const std::string FRACO = "\033[2m";
	const std::string ITALICO = "\033[3m";
	const std::string SUBLINHADO = "\033[4m";
	const std::string INVERTE_CORES = "\033[7m";
}
...
public:
	...
	//mapeamento de schema | suas tables
	//static std::map<std::string, std::vector<std::string>> rpm_base;

	//nome da query | query
	//static std::map<std::string, std::string> querys;
